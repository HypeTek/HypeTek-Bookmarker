<p align="center">
  <img src="docs/default-theme.jpg" alt="HypeTek Server Launcher default cyberpunk theme" width="820">
</p>

<h1 align="center">HypeTek Server Launcher</h1>

<p align="center">
  A lightweight, portable launcher for Windows 10/11 that opens your server and web interfaces with one click.
</p>
...
<p align="center">
  ...
  <img alt="Version 3.6" src="https://img.shields.io/badge/version-3.6%20preview-2ea44f">
...
- Server address shown below each tile label
...
- **Subtle “Default design” reset** in Settings; it resets appearance only and never deletes server entries
...
It does **not** change or delete saved servers.
...
4. Start `Start_ServerLauncher.vbs`.
...
The launcher does not send saved server addresses or settings anywhere.
...
Stable release: **v3.5**  
Development branch / next release: **v3.6**
...
Der **HypeTek Server Launcher** ist ein portabler Windows-Launcher für Weboberflächen, NAS, Server, PCs und andere Netzwerkziele.
...
Der Design-Reset verändert ausschließlich Darstellungseinstellungen und löscht keine Server.
